...
export class WinnersUnique extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            axisYTitle: "Skirtingų laimėtojų skaičius, vnt.",
            axisYLabelAngle: 0,
        ...
        if (this.state.winnersUnique.length > 0) {
            ...
            if (this.state.axisYMaximum === '') {
                ...
                for (let i = 0; i < this.state.winnersUnique.length; i++) {
                    if (defaultMaximum < this.state.winnersUnique[i].uniqueWinnersCount) {
                        defaultMaximum = this.state.winnersUnique[i].uniqueWinnersCount;
                    }
                }
